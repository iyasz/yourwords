...
@section('content')
    <div class=" mt-10">
        <h1 class="text-white text-center font-bold lg:text-2xl md:text-[30px] text-[20px] tracking-wide">Edit Project</h1>

        <div class="mt-8">
            <div class="flex justify-center">
                <div class="">
                    <a href="/project/list/{{$project->id}}" class="inline-block">
                        ...
                        <div class="card-body md:p-5 p-3">
                            <form action="/project/{{$project->id}}/edit" method="post">
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="text" maxlength="100" value="{{$project->title}}" name="title" id="title" required class="w-full p-3 mt-2 text-slate-200 rounded-md foucs:outline-none focus-visible:outline-none bg-zinc-800 border-[1px] border-zinc-600" placeholder="Example">
                                </div>
                                <div class="mb-5">
                                    <label for="description" class="text-slate-200 text-sm">Deskripsi</label>
                                    <textarea name="description" required id="description" class="w-full p-3 mt-2 text-slate-200 rounded-md foucs:outline-none focus-visible:outline-none bg-zinc-800 border-[1px] border-zinc-600" placeholder="Something here .." cols="30" rows="6">{{$project->description}}</textarea>
                                </div>
